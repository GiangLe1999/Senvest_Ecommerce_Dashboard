...
const ProductVideos: FC<Props> = ({ files, setValue, error }) => {
  // Hooks
  ...
  const renderFilePreview = (file: FileProp) => {
    if (file.type.startsWith("video")) {
      return (
        <video width={38} height={38} controls>
          <source src={URL.createObjectURL(file as any)} type={file.type} />
        </video>
      );
    } else {
      return <i className="ri-file-video-line" />;
    }
  };
      ...
      <div {...getRootProps({ className: "dropzone" })}>
        ...
        <div className="flex items-center flex-col gap-2 text-center">
          ...
          <Typography variant="h5">
            Drag and Drop Product Videos Here
          </Typography>
